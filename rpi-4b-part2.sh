...
# 修改机器名称
sed -i 's/ImmortalWrt/RaspberryPi4B/g' package/base-files/files/bin/config_generate
...
wget https://raw.githubusercontent.com/EnnawYang/Actions-OpenWrt/main/files/rpi-4b-wireless -O files/etc/config/wireless
